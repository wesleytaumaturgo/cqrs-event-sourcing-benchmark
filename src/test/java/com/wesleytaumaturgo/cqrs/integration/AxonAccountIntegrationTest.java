...
/**
 * Testes de integração da implementação Axon (ES Axon Framework 4.9).
 * Valida paridade de contrato com a implementação Manual (REQ-6.EARS-1)
...
class AxonAccountIntegrationTest {
    ...
    // ─── REQ-6.EARS-1: Contrato idêntico ao Manual ────────────────────────────
    ...
    void deposit_shouldReturn404_whenAccountNotFound() throws Exception {
        // REQ-6.EARS-1
        var unknownId = "00000000-0000-0000-0000-000000000021";
    ...
    void getBalance_shouldReturn404_whenAccountNotFound() throws Exception {
        // REQ-6.EARS-1
        var unknownId = "00000000-0000-0000-0000-000000000022";
    ...
    // ─── REQ-6.EARS-2: Evento persistido no PostgreSQL (domain_event_entry) ───

    @Test
    void openAccount_shouldPersistEventInDomainEventEntry() throws Exception {
        // REQ-6.EARS-2
        createAccount("owner-2", "100.00");

        var count = jdbc.queryForObject(
            "SELECT COUNT(*) FROM domain_event_entry WHERE type = 'BankAccountAggregate'",
            Long.class);
        assertThat(count).isGreaterThanOrEqualTo(1L);
    }

    @Test
    void deposit_shouldPersistEventInDomainEventEntry() throws Exception {
        // REQ-6.EARS-2
